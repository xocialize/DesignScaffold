...
Current release: **0.19.0** · `https://github.com/xocialize/DesignScaffold` (public, MIT).
...
<!-- Generated by Tools/scan-adopters.py — do not hand-edit. Release 0.19.0. -->

| Adopter | Project | Products used | Files | Pin | |
|---|---|---|---|---|---|
| **Audio8 Demo** | Demos | `DesignScaffold`, `DesignScaffoldControls`, `DesignScaffoldMetrics`, `DesignScaffoldStatus` | 9 | 0.16.0 | behind (0.19.0) |
| **Gepard Demo** | Demos | `DesignScaffold`, `DesignScaffoldControls` | 1 | 0.16.0 | behind (0.19.0) |
| **Liquid LFM 2.5 Demo** | Demos | `DesignScaffold`, `DesignScaffoldControls` | 6 | 0.16.0 | behind (0.19.0) |
| **ML[X] Audio Studio** | ml(x) | `DesignScaffold`, `DesignScaffoldPlaylist`, `DesignScaffoldStatus`, `DesignScaffoldWaveform`, `DesignScaffoldWorkspace` | 21 | 0.14.0 | behind (0.19.0) |
| **ML[X] LTX Studio** | ml(x) | `DesignScaffold`, `DesignScaffoldChips`, `DesignScaffoldLoading`, `DesignScaffoldStageStepper`, `DesignScaffoldTimeline` | 10 | 0.17.0 | behind (0.19.0) |
| **ML[X] Media Optimizer** | ml(x) | `DesignScaffold` | 3 | 0.2.0 | behind (0.19.0) |
| **MarqueeStudio** | MVSCollective | `DesignScaffold`, `DesignScaffoldCalendar`, `DesignScaffoldPicker`, `DesignScaffoldPlaylist`, `DesignScaffoldWorkspace` | 12 | 0.11.0 | behind (0.19.0) |
| **MarqueeSurface** | MVSCollective | `DesignScaffold` | 5 | 0.19.0 | ✅ |
| **Moebius Demo** | Demos | `DesignScaffold`, `DesignScaffoldControls` | 5 | 0.16.0 | behind (0.19.0) |
| **SenseNova-U1.5 Demo** | Demos | `DesignScaffold`, `DesignScaffoldControls` | 7 | 0.16.0 | behind (0.19.0) |
| **mlx-engine-swift** | MLXEngine | `DesignScaffold` | 5 | 0.4.2 | behind (0.19.0) |
