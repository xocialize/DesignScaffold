...
<!-- Generated by Tools/scan-adopters.py — do not hand-edit. Release 0.4.1. -->

| Adopter | Project | Products used | Files | Pin | |
|---|---|---|---|---|---|
| **ML[X] LTX Studio** | ml(x) | `DesignScaffold`, `DesignScaffoldLoading`, `DesignScaffoldStageStepper` | 4 | 0.4.0 | ⚠️ 0.4.1 available |
| **ML[X] Media Optimizer** | ml(x) | `DesignScaffold` | 3 | 0.2.0 | ⚠️ 0.4.1 available |
| **mlx-engine-swift** | MLXEngine | `DesignScaffold` | 5 | 0.4.1 | 🚧 in progress (uncommitted) |
