...
| **Timeline T2/T3** — drag, cross-track move, edge trim, snapping (T2); in/out brackets, gap indicators, marquee, row resize (T3) | AB-A-0031 | T1 shipped 0.5.0. T2/T3 planned; the points-based snap conversion already exists in `TimelineGeometry`. |
