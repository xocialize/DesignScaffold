...
Current release: **0.23.0** · `https://github.com/xocialize/DesignScaffold` (public, MIT).
...
<!-- Generated by Tools/scan-adopters.py — do not hand-edit. Release 0.22.0. -->
...
| **MarqueeSurface** | MVSCollective | `DesignScaffold`, `DesignScaffoldStatus` | 5 | 0.20.0 | behind (0.22.0) |
| **Moebius Demo** | Demos | `DesignScaffold`, `DesignScaffoldControls` | 5 | 0.16.0 | behind (0.22.0) |
| **SenseNova-U1.5 Demo** | Demos | `DesignScaffold`, `DesignScaffoldControls` | 7 | 0.16.0 | behind (0.22.0) |
| **mlx-engine-swift** | MLXEngine | `DesignScaffold` | 5 | 0.4.2 | behind (0.22.0) |
