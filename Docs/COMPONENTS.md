...
Current release: **0.7.0** · `https://github.com/xocialize/DesignScaffold` (public, MIT).
...
<!-- Generated by Tools/scan-adopters.py — do not hand-edit. Release 0.7.0. -->

| Adopter | Project | Products used | Files | Pin | |
|---|---|---|---|---|---|
| **ML[X] Audio Studio** | ml(x) | `DesignScaffold` | 2 | 0.4.2 | ⚠️ 0.7.0 available |
| **ML[X] LTX Studio** | ml(x) | `DesignScaffold`, `DesignScaffoldLoading`, `DesignScaffoldStageStepper`, `DesignScaffoldTimeline` | 6 | 0.6.2 | ⚠️ 0.7.0 available |
| **ML[X] Media Optimizer** | ml(x) | `DesignScaffold` | 3 | 0.2.0 | ⚠️ 0.7.0 available |
| **SenseNova-U1.5 Demo** | Demos | `DesignScaffold` | 7 | 0.6.0 | ⚠️ 0.7.0 available |
| **mlx-engine-swift** | MLXEngine | `DesignScaffold` | 5 | 0.4.2 | ⚠️ 0.7.0 available |
